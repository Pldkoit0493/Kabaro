...
export default function FrontProductsFilter({ isShowCategory, isShowShortBy, isShowFilter }: { isShowCategory: boolean, isShowShortBy: boolean, isShowFilter: boolean }) {
